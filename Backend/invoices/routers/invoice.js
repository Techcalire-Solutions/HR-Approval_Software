...
router.post('/download-excel', async (req, res) => {
  ...
  try {
    ...
    worksheet.columns = [
      ...
      { header: 'Amount', key: 'supplierPrice', width: 15 },
      ...
      { header: 'Customer Price', key: 'customerPrice', width: 15 },
    ...
    data.forEach(item => {
      worksheet.addRow({
        ...
        createdDate: item.createdAt ? new Date(item.createdAt).toLocaleString() : '',
        updatedDate: item.updatedAt ? new Date(item.updatedAt).toLocaleString() : '',
