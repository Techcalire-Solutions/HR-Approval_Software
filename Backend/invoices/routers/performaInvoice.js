...
const transporter = nodemailer.createTransport({
  ...
  router.post('/save', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        : `A new Proforma Invoice ${piNo} has been generated by ${req.user.name}.`;

    const notificationUser = status === 'INITIATED' ? am : kam;
...
// Find the accountant's email
const accountant = users.find(user => user.id === pi.accountantId);
if (accountant) {
    ccEmails.push(accountant.email);
    console.log("Added accountant email to CC:", accountant.email);
} else {
    console.log("Accountant Not Found for ID:", pi.accountantId);
}
